...
class DetallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle" do
    assert_difference("Detalle.count") do
      post detalles_url, params: { detalle: { Libros_id: @detalle.Libros_id, Prestamo_id: @detalle.Prestamo_id, cantidad: @detalle.cantidad } }
    end
  ...
  test "should update detalle" do
    patch detalle_url(@detalle), params: { detalle: { Libros_id: @detalle.Libros_id, Prestamo_id: @detalle.Prestamo_id, cantidad: @detalle.cantidad } }
